...
// const url = util.url
// const testTeacher = util.testTeacher
const { url, testTeacher } = util;
...
describe('Get list of students registered under ALL teachers in list provided', () => {
  it('should have students array when passed valid teacher', req1);
  it('should have students array when passed multiple teachers', req2);
